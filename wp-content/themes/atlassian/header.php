    ...
    <div class="container ">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div id="logo" > <span class="bglogo1 transform-please-2"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php header_image(); ?>" width="<?php echo get_custom_header()->width; ?>" height="<?php echo get_custom_header()->height; ?>" alt="logo"/></a></span> <span class="bglogo2 transform-please-2"></span> <span class="bglogo3 transform-please-2"></span> <span class="bglogo4 transform-please-2"></span> </div>
                <?php endif; ?>
            </div>
        </div>
    </div>
